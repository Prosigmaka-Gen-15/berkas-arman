      ...
      <div className="flex flex-col ml-19">
        ...
        <div className="flex flex-row shadow-sm mt-3">
          <div className="flex flex-row w-24 justify-between px-3 py-1 border border-gray-400 items-center rounded-full bg-gray-200">
            <button onClick={decreaseValue} className="w-4 h-4 flex items-center justify-center text-green-700 rounded-full">
              -
            </button>
            <p className="text-green-700">{angkaAwal}</p>
            <button onClick={increaseValue} className="w-4 h-4 flex items-center justify-center text-green-700 rounded-full">
              +
            </button>
          </div>
          <p className="ml-5">
